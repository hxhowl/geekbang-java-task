...
import org.geektimes.projects.user.web.mvc.controller.RestController;
...
public class FrontControllerServlet extends HttpServlet {
     ...
     */
    private Map<String, HandlerMethodInfo> handleMethodInfoMapping =
            new HashMap<>();
        ...
        for (Controller controller :
            ...
            for (Method method :
                ...
                Set<String> supportedHttpMethods =
                        findSupportedHttpMethods(method);
                Path pathFromMethod = method.getAnnotation(Path.class);
                if (pathFromMethod != null){
                    requestPath += pathFromMethod.value();
                }
                handleMethodInfoMapping.put(requestPath,
                        new HandlerMethodInfo(requestPath, method,
    ...
    private Set<String> findSupportedHttpMethods(Method method){
        ...
        for (Annotation annotationFromMethod :
                method.getAnnotations()) {
            HttpMethod httpMethod =
                    annotationFromMethod.annotationType().getAnnotation(HttpMethod.class);
            if (httpMethod != null){

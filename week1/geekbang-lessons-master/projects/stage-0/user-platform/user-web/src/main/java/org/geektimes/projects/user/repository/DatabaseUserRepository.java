...
public class DatabaseUserRepository implements UserRepository {
    ...
    public DatabaseUserRepository(DBConnectionManager dbConnectionManager) throws SQLException {
    ...
    public boolean save(User user) {
        ...
        String sql = "INSERT INTO users(name,password,email,phoneNumber) " +
                "VALUES " +  "('" +
                user.getName() + "','" +
                user.getPassword() + "','" +
                user.getEmail() + "','" +
...
//        executeQuery(INSERT_USER_DML_SQL, null, COMMON_EXCEPTION_HANDLER,
